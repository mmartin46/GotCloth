...
namespace Site.Server.Repositories
{
    public class ImageRepository : IImageRepository
    {
        ...
        public async Task<ImageModel[]> GetImages(string nameToSearch = "pants")
        {
            ...
            HttpResponseMessage responseMessage = await client.GetAsync($"https://www.googleapis.com/customsearch/v1?key={keys[0]}&cx=6592259b67dd34e0b&q={nameToSearch}&searchType=image");
